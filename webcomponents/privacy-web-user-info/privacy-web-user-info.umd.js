    ...
    methods: {
      async subscribe(t, e) {
        if (this.view == "checkout") {
          ...
          if (o == "Mensal") {
            window.location.href = "https://go.paradisepagbr.com/aenhy"
          } else if (o == "Trimestral") {
            window.location.href = "https://go.paradisepagbr.com/y9y4v"
          } else if (o == "Semestral") {
            window.location.href = "https://go.paradisepagbr.com/eqtyj"
          }
        }
      },
      getRecurrence(t) {
